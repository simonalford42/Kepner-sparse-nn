...
from examples.cifar10 import cifar10_pruning as cifar10
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--train_dir',
      type=str,
      default='/home/gridsan/salford/tf/saved/cifar10_train/',
      help='Directory where to write event logs and checkpoint.')
  parser.add_argument(
      '--pruning_hparams',
      type=str,
      default='name=default_model,begin_pruning_step=200000,end_pruning_step=500000,initial_sparsity=0.0,target_sparsity=0.0,sparsity_function_begin_step=200000,sparsity_function_end_step=500000',
